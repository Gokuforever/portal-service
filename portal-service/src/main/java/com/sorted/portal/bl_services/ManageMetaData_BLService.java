...
import com.sorted.common.exceptions.LocationNotFoundException;
...
import com.sorted.common.service.PreferencesHandlerService;
...
public class ManageMetaData_BLService {
    ...
    public com.sorted.common.beans.Config getPreferencesV2(@PathVariable String lat, @PathVariable String lng, HttpServletRequest httpServletRequest) {
...
//                    .secure(Boolean.TRUE.equals(product.getIs_secure()))
    ...
    private List<Product_Master> getProductMasters() {
        ...
        filterPM.addProjection(Product_Master.Fields.name, Product_Master.Fields.catagory_id, Product_Master.Fields.sub_categories, Product_Master.Fields.cdn_url, Product_Master.Fields.group_id, Product_Master.Fields.mrp, Product_Master.Fields.desc);
